...
class Reuser
{
  ...
  {
    if (array_key_exists(($version == ApiVersion::V1? "reuse_upload" : "reuseUpload"), $reuserArray)) {
      $this->setReuseUpload($reuserArray[$version == ApiVersion::V1? "reuse_upload" : "reuseUpload"]);
    }
    if (array_key_exists(($version == ApiVersion::V1? "reuse_group" : "reuseGroup"), $reuserArray)) {
      $this->reuseGroup = $reuserArray[$version == ApiVersion::V1? "reuse_group" : "reuseGroup"];
    }
    if (array_key_exists(($version == ApiVersion::V1? "reuse_main" : "reuseMain"), $reuserArray)) {
      $this->setReuseMain($reuserArray[$version == ApiVersion::V1? "reuse_main" : "reuseMain"]);
    }
    if (array_key_exists(($version == ApiVersion::V1? "reuse_enhanced" : "reuseEnhanced"), $reuserArray)) {
      $this->setReuseEnhanced($reuserArray[$version == ApiVersion::V1? "reuse_enhanced" : "reuseEnhanced"]);
    }
    if (array_key_exists(($version == ApiVersion::V1? "reuse_report" : "reuseReport"), $reuserArray)) {
      $this->setReuseReport($reuserArray[$version == ApiVersion::V1? "reuse_report" : "reuseReport"]);
    }
    if (array_key_exists(($version == ApiVersion::V1? "reuse_copyright" : "reuseCopyright"), $reuserArray)) {
      $this->setReuseCopyright($reuserArray[$version == ApiVersion::V1? "reuse_copyright" : "reuseCopyright"]);
    }
