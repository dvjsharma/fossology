...
class Decider
{
  ...
  {
    if (array_key_exists(($version == ApiVersion::V1? "nomos_monk" : "nomosMonk"), $deciderArray)) {
      $this->nomosMonk = filter_var($deciderArray[$version == ApiVersion::V1? "nomos_monk" : "nomosMonk"],
        FILTER_VALIDATE_BOOLEAN);
    }
    if (array_key_exists(($version == ApiVersion::V1? "bulk_reused" : "bulkReused"), $deciderArray)) {
      $this->bulkReused = filter_var($deciderArray[$version == ApiVersion::V1? "bulk_reused" : "bulkReused"],
        FILTER_VALIDATE_BOOLEAN);
    }
    if (array_key_exists(($version == ApiVersion::V1? "new_scanner" : "newScanner"), $deciderArray)) {
      $this->newScanner = filter_var($deciderArray[$version == ApiVersion::V1? "new_scanner" : "newScanner"],
        FILTER_VALIDATE_BOOLEAN);
    }
    if (array_key_exists(($version == ApiVersion::V1? "ojo_decider" : "ojoDecider"), $deciderArray)) {
      $this->ojoDecider = filter_var($deciderArray[$version == ApiVersion::V1? "ojo_decider" : "ojoDecider"],
        FILTER_VALIDATE_BOOLEAN);
    }
    return $this;
  }
